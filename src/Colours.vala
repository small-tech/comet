// Colours
// (See https://elementary.io/brand#color).
// Note: it looks like elementary OS uses the
// Material Design naming for colours but their
// “weights” don’t seem to be the same, at least
// based on https://material.io/design/color/the-color-system.html#tools-for-picking-colors
